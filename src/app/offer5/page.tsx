...
function Offer5Content() {
    ...
    useEffect(() => {
        ...
        console.log('Offer 5 viewed - Current rotation index:', localStorage.getItem('redirector_rotation_index'));
    }, [searchParams]);
        ...
        <div className="min-h-screen bg-gradient-to-br from-indigo-500 to-purple-700 flex items-center justify-center p-4">
            <div className="max-w-md w-full bg-white rounded-xl shadow-2xl p-8 text-center">
                ...
                <p className="text-sm text-gray-500 mt-6">
                    Close this tab and return to the home page to complete the cycle
                </p>
            </div>
        </div>
    );
